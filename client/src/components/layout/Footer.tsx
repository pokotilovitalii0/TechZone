			...
			<div className="container mx-auto px-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
					...
					<div className="col-span-1 md:col-span-1">
						<h3 className="text-2xl font-bold text-white mb-4">Tech<span className="text-sky-500">Zone</span></h3>
						...
						<div className="flex gap-4">
							{[Facebook, Instagram, Twitter].map((Icon, i) => (
								<a key={i} href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-sky-500 hover:text-white transition-all duration-300">
									<Icon size={18} />
								</a>
							))}
						</div>
				...
				<div className="border-t border-slate-800 pt-8 text-center text-xs opacity-50">
					&copy; {new Date().getFullYear()} TechZone. Всі права захищені. Design by You.
				</div>
			</div>
		</footer>
	);
